...
df['city'].value_counts().head(5).plot(
    kind="barh", 
    grid=True,
    title="Top 5 cities with the most startups",
    xlabel="Number of startups",
    ylabel="Cities")
plt.show()
...
# Назви стовпчиків
categories = ['Received a grant', 'Did not receive a grant']
...
ax.set_title('Number of startups that received and did not receive a grant')
# Показ діаграми
plt.show()
...
yearly_startup_count.head(5).plot(
    kind="barh", 
    grid=True,
    title="Top 5 years by number of startups",
    xlabel="Number of startups",
    ylabel="Years")
plt.show()
...
category_count.head(5).plot(
    kind="barh", 
    grid=True,
    title="Top 5 most popular categories by number of startups",
    xlabel="Number of startups",
    ylabel="Categories")
plt.show()
